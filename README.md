...
Fixes/Improvements in version 1.2.4
 - Improved support for variations in API data returned for differing models of Neo systems
...
Fixes/Improvements in version 1.2.3
 ...
 - Implemented JSON Typedef schema validation for all Neo API responses, see [Schema Validation Errors](#schema-validation-errors)
